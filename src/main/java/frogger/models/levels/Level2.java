...
/**
 * <p>The class Level2 is a level that is played by the user in the Frogger Game.</p>
 * <p>Level2 can be customized through adding different {@link frogger.models.actors.Actor}s in its constructor.</p>
 */
public class Level2 extends Level {
	
	/**
	 * <p>The constructor of Level2</p>
